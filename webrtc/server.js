...
io.on("connection", (socket) => {
  ...
  // Modify the newAnswer handler in server.js
  socket.on("newAnswer", (offerObj, ackFunction) => {
    ...
    // Add null check for ackFunction
  ...
  socket.on("disconnect", (reason) => {
    ...
    if (index !== -1) {
      const userName = connectedSockets[index].userName;

      // Remove their offer(s) from the offers array
      ...
      // Optionally, notify others that offers have changed
